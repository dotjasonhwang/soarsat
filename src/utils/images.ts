...
// OpenGraph image type for internal use
...
/** Process an image URL and return optimized OpenGraph image data */
export const getOpenGraphImage = async (
  ...
  const resolvedImage = (await findImage(imageUrl)) as ImageMetadata | string | undefined;
  if (!resolvedImage) {
    return undefined;
  }
